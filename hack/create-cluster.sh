...
if [ "$platform" == 'Azure' ]; then
    ...
    hypershift create cluster aws \
        --aws-creds "$HOME/hypershift/my/config/awscredentials" \
        --pull-secret config/.dockerconfigjson \
        --name "$CLUSTER_NAME" \
